...
type Client interface {
	Ping(ctx context.Context, Req *device.PingReq, callOptions ...callopt.Option) (r *openiot.BaseRsp, err error)
...
func (p *kOpeniotDeviceServiceClient) Ping(ctx context.Context, Req *device.PingReq, callOptions ...callopt.Option) (r *openiot.BaseRsp, err error) {
