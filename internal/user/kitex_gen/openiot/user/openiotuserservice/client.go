...
type Client interface {
	Ping(ctx context.Context, Req *user.PingReq, callOptions ...callopt.Option) (r *openiot.BaseRsp, err error)
...
func (p *kOpeniotUserServiceClient) Ping(ctx context.Context, Req *user.PingReq, callOptions ...callopt.Option) (r *openiot.BaseRsp, err error) {
